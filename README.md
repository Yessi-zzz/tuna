...
<p align="center">
  <img src="docs/screenshots/main.png" alt="Tuna 主界面" width="820">
</p>
<p align="center"><i>主界面:一键切换 安静 / 均衡 / 性能 / 自定义(当前档高亮),插拔电自动切档,刷新率切换、屏幕超频、独显直连、系统开关。深色黑橙主题。</i></p>

### 各档参数对比(只读,直接读硬件能力表 `LENOVO_CAPABILITY_DATA_01`)

下面是开发机(Legion R9000P 2025 · Ryzen 9 8945HX + RTX 5070 Ti)实读到的三档功耗参数 —— 数据由机器自报,换机型自动变化:

**CPU**

| 参数 | 单位 | 安静 | 均衡 | 性能 | 可选范围 |
|---|:--:|:--:|:--:|:--:|:--:|
| 短时功率 PL2/sPL | W | 65 | 95 | 145 | 60–145 |
| 长时功率 PL1 | W | 55 | 90 | 130 | 50–140 |
| 峰值功率 sPPT | W | 75 | 102 | 174 | 70–174 |
| 温度墙 | °C | 100 | 100 | 100 | 85–100 |
| 交叉负载功率 | W | 35 | 70 | 75 | 30–100 |

**GPU**

| 参数 | 单位 | 安静 | 均衡 | 性能 | 可选范围 |
|---|:--:|:--:|:--:|:--:|:--:|
| 功率加成 Boost | W | 0 | 15 | 25 | 0 / 15 / 20 / 25 |
| 可配置功耗 cTGP | W | 70 | 80 | 115 | 70 / 80 / 90 / 100 / 115 |
| 温度墙 | °C | 87 | 87 | 87 | 75–87 |
| 目标功耗偏移 TPP | W | 20 | 55 | 105 | 10–130 |

> 风扇曲线(每风扇 温度→转速 折线)在程序内以只读折线图展示。
